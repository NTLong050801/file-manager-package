...
Route::middleware('web')->group(function () {
    ...
    Route::get('image-preview/{pathFile}', [AjaxController::class, 'showImageFromStorage'])
        ->where('pathFile', '.*')->name('show-image-from-storage');
    Route::prefix('ajax')->group(function () {
        ...
        Route::get('/preview-file', [AjaxController::class, 'preview'])->name('ajax.preview');
